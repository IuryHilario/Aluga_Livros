...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-md border-l-4 border-amber-500 p-4 sm:p-6">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl sm:text-3xl font-bold text-gray-900">Aluguéis Ativos</h2>
                <p class="text-gray-600 text-sm mt-1">Gerencie todos os aluguéis em andamento</p>
            </div>
            <div class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                ...
                <a href="{{ route('rentals.create') }}" class="flex items-center justify-center px-4 py-2 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition-colors duration-200 text-sm font-medium shadow-md hover:shadow-lg">
                    <i class="fas fa-plus mr-2"></i> Novo Aluguel
                </a>
            </div>
        </div>
    </div>
